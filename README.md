...
# Program name: contact_manager
Allen Le, Oliver Albert
## <Contact_Manager> Description
...
```
conctact_ will be removed from the beginning of each function
main -> menu
menu -> add -> menu
menu -> search -> menu
menu -> edit -> menu
